...
function(vtksdk_generate_package_init package_name)
  ...
  if(NOT arg_INPUT AND NOT arg_CONTENT)
    set(arg_CONTENT "@PACKAGE_INIT@") # use this when no input or content specified
  endif()
  ...
  # Generate PACKAGE_INIT drop-in replacement
  ...
  string(APPEND PACKAGE_INIT "# VTK dependencies\n")
  foreach(module IN LISTS module_deps)
    string(REPLACE "VTK::" "vtk" _name "${module}")
    string(APPEND PACKAGE_INIT "from vtkmodules.${_name} import *\n")
  endforeach()

  # Generate import of given modules
  string(APPEND PACKAGE_INIT "# This package modules\n")
  foreach(module IN LISTS arg_MODULES)
  ...
  if(arg_CONTENT) # transform arg content into a file as configure_file can only take... files
